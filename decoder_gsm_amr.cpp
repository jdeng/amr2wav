        ...
        bool aAllocateOutputBuffer)
{
    ...
    {
        iInputBuf = new int16[MAX_NUM_PACKED_INPUT_BYTES]; //OSCL_ARRAY_NEW(int16, MAX_NUM_PACKED_INPUT_BYTES);
        if (iInputBuf == NULL)
        {
    ...
    {
        iOutputBuf = new int16[L_FRAME]; // OSCL_ARRAY_NEW(int16, L_FRAME);
